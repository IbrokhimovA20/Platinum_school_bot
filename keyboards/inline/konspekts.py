...
nazad_5 = InlineKeyboardButton(text='назад к темам', callback_data='nazad_5')
nazad_6 = InlineKeyboardButton(text='назад к темам', callback_data='nazad_6')
...
nod_nok = InlineKeyboardMarkup(row_width=1)
nod_nok.insert(InlineKeyboardButton(text='конспект', callback_data=lesson_callback.new(item_name='kons_nod_nok')))
nod_nok.insert(InlineKeyboardButton(text='видеоурок', url='https://youtu.be/5D8Z74at47o'))
nod_nok.insert(InlineKeyboardButton(text='тесты', callback_data=lesson_callback.new(item_name='test_nod_nok')))
nod_nok.insert(nazad_5)

obiknovenniye_drobi = InlineKeyboardMarkup(row_width=1)
obiknovenniye_drobi.insert(InlineKeyboardButton(text='конспект', callback_data=lesson_callback.new(item_name='kons_obiknovenniye_drobi')))
obiknovenniye_drobi.insert(InlineKeyboardButton(text='видеоурок', url='https://youtu.be/5D8Z74at47o'))
obiknovenniye_drobi.insert(InlineKeyboardButton(text='тесты', callback_data=lesson_callback.new(item_name='test_obiknovenniye_drobi')))
obiknovenniye_drobi.insert(nazad_5)

desyatichniye_drobi = InlineKeyboardMarkup(row_width=1)
desyatichniye_drobi.insert(InlineKeyboardButton(text='конспект', callback_data=lesson_callback.new(item_name='kons_desyatichniye_drobi')))
desyatichniye_drobi.insert(InlineKeyboardButton(text='видеоурок', url='https://youtu.be/5D8Z74at47o'))
desyatichniye_drobi.insert(InlineKeyboardButton(text='тесты', callback_data=lesson_callback.new(item_name='test_desyatichniye_drobi')))
desyatichniye_drobi.insert(nazad_5)

zadachi_na_dvijeniye = InlineKeyboardMarkup(row_width=1)
zadachi_na_dvijeniye.insert(InlineKeyboardButton(text='конспект', callback_data=lesson_callback.new(item_name='kons_zadachi_na_dvijeniye')))
zadachi_na_dvijeniye.insert(InlineKeyboardButton(text='видеоурок', url='https://youtu.be/5D8Z74at47o'))
zadachi_na_dvijeniye.insert(InlineKeyboardButton(text='тесты', callback_data=lesson_callback.new(item_name='test_zadachi_na_dvijeniye')))
zadachi_na_dvijeniye.insert(nazad_5)
...
delimosti_chisel.insert(nazad_5)

bes_per_drobi = InlineKeyboardMarkup(row_width=1)
bes_per_drobi.insert(InlineKeyboardButton(text='конспект', callback_data=lesson_callback.new(item_name='kons_bes_per_drobi')))
bes_per_drobi.insert(InlineKeyboardButton(text='видеоурок', url='https://youtu.be/5D8Z74at47o'))
bes_per_drobi.insert(InlineKeyboardButton(text='тесты', callback_data=lesson_callback.new(item_name='test_bes_per_drobi')))
bes_per_drobi.insert(nazad_6)
...
parallelogram.insert(InlineKeyboardButton(text='видеоурок', callback_data=lesson_callback.new(item_name='vid_parallelogram')))
